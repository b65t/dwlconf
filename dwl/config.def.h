...
static const float shadow_color[7] = COLOR(0x000000ff);
static const float shadow_color_focus[7] = COLOR(0x000000ff);
...
static const char *screenshot[] = {
    "sh", "-c", "grim - | wl-copy && notify-send 'Screenshot taken' 'check your clipboard'", 
    NULL
};
static const char *pscreenshot[] = {
